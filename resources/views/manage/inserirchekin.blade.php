...
<?php $page_name = "Inserir Check-in" ?>
@section('content')
...
<div class="container-fluid">
    ...
    <div class="card shadow">                    
        <div class="card-header py-3">
            <p class="text-primary m-0 fw-bold">Inserir Check-in</p>
        </div>
        <div class="card-body">
            ...
            @endif
            <form method="post" class="user" action="{{ url('/manage/inserircheckin') }}">
            {{ csrf_field() }}
            <div class="row">
                    <div class="col">
                    ...
                    <div class="col">
                    <div class="mb-3"><label class="form-label" for="data"><strong>Data</strong></label><input class="form-control" data-provide="datepicker" id="data" name="data"></div>                    
                    </div>
                </div>                                
